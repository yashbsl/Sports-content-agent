...
function CustomSelect({ label, value, options, onChange, icon = "◈" }) {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {open && (
        <div className="absolute left-0 right-0 top-full z-[100] mt-2 overflow-hidden rounded-2xl border border-white/[0.08] bg-[#111827] p-1.5 shadow-2xl shadow-black/50">
          {options.map((option) => {
        ...
        <div className="p-6 sm:p-7">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="rounded-xl border border-blue-400/20 bg-blue-400/10 px-3 py-2 text-xs font-medium text-blue-300 transition hover:bg-blue-400/15 disabled:cursor-not-allowed disabled:opacity-50"
              >
          ...
          {type === "guess_number" && (
            <div className="mt-6 rounded-2xl border border-blue-400/20 bg-blue-500/[0.06] p-6">
              ...
              <p className="mt-2 text-4xl font-bold">{item.target}</p>
            ...
            <div className="mt-4 rounded-2xl border border-white/[0.06] bg-white/[0.02] p-5">
              ...
              <div className="space-y-3">
                {item.knowledge_sources.map((source, sourceIndex) => (
                  <div key={sourceIndex} className="rounded-xl bg-black/10 p-3">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-[1500px]">
        ...
        <aside className="hidden w-64 shrink-0 border-r border-white/[0.06] px-5 py-6 lg:block">
          <div className="flex items-center gap-3 px-2">
            ...
            <div>
              <p className="text-sm font-bold">Sports AI</p>

              <p className="text-xs text-slate-600">Content Studio</p>
            </div>
          </div>
          ...
          <div className="mt-10 space-y-2">
            ...
            <button
              type="button"
              className="w-full rounded-xl px-4 py-3 text-left text-sm text-slate-500 transition hover:bg-white/[0.03] hover:text-slate-300"
            >
              ⚙ &nbsp; Settings
            </button>
          </div>
          ...
          <div className="mt-10 rounded-2xl border border-white/[0.06] bg-white/[0.02] p-4">
            <p className="text-xs font-semibold text-slate-400">Local AI</p>
        ...
        <main className="min-w-0 flex-1 px-5 py-6 sm:px-8 lg:px-10 lg:py-8">
          ...
          {/* History */}
          {showHistory && (
            <section className="relative z-20 mb-8 rounded-3xl border border-white/[0.08] bg-slate-900/80 p-6 shadow-2xl backdrop-blur-xl">
              <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                {history.length > 0 && (
                  <button
                    ...
                    className="w-fit text-xs font-medium text-rose-400 transition hover:text-rose-300"
                  >
                    Clear History
                  </button>
                )}
                ...
                <div className="space-y-3">
                  {history.map((item) => (
                    <button
                      ...
                      className="w-full rounded-2xl border border-white/[0.06] bg-white/[0.02] p-4 text-left transition hover:border-blue-400/20 hover:bg-blue-400/[0.03]"
                    >
                ...
                <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-2xl border border-white/[0.08] bg-white/[0.03] px-4 py-3.5 text-sm text-white outline-none transition focus:border-blue-400/40 focus:bg-white/[0.05]"
                    />
                  </div>
                </div>
                ...
                <section className="relative z-10 mt-10">
                  <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                    ...
                    <button
                      ...
                      className="inline-flex items-center justify-center gap-2 rounded-xl border border-white/[0.08] bg-white/[0.03] px-4 py-2.5 text-sm font-medium text-slate-300 transition hover:border-blue-400/20 hover:bg-blue-400/[0.05] hover:text-blue-300"
                    >
                      ↓ Export JSON
                    </button>
                  </div>
